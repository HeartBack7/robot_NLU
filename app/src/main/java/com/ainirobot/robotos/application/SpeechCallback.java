...
public class SpeechCallback extends SkillCallback {
    ...
    public interface NluResultListener {
        void onNluResult(String rawResult);
        void onAsrResult(String asrResult);
    }

    private static NluResultListener sNluResultListener;

    public static void setNluResultListener(NluResultListener listener) {
        sNluResultListener = listener;
    }

    @Override
    public void onSpeechParResult(String s) throws RemoteException {
        LogTools.info(TAG +" onSpeechParResult:"+ s);
        if (sNluResultListener != null) {
            sNluResultListener.onNluResult(s);
        }
    }
    ...
    public void onQueryAsrResult(String asrResult) throws RemoteException {
        ...
        if (sNluResultListener != null) {
            sNluResultListener.onAsrResult(asrResult);
        }
    }
}
