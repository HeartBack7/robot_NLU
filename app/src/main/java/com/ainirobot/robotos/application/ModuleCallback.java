...
public class ModuleCallback extends ModuleCallbackApi {
    ...
    public interface SpeechRequestListener {
        void onSpeechRequest(int reqId, String reqType, String reqText, String reqParam);
    }

    private static SpeechRequestListener sSpeechRequestListener;

    public static void setSpeechRequestListener(SpeechRequestListener listener) {
        sSpeechRequestListener = listener;
    }
    ...
    public boolean onSendRequest(int reqId, String reqType, String reqText, String reqParam) throws RemoteException {
        ...
        LogTools.info(text);
        if (sSpeechRequestListener != null) {
            sSpeechRequestListener.onSpeechRequest(reqId, reqType, reqText, reqParam);
        }
        return true;
    }
